...
settpd(val) {
 ...
 @action setatime=(obj)=>{         //set trip
   ...
   @action setispickup=(obj)=>{         //set trip
    this.ispickup=obj
   }

   @action setisdropoff=(obj)=>{         //set trip
    this.isdropoff=obj
   }

   @action setchalo=(obj)=>{         //set trip
    this.chalo=obj
   }


   @action setarrive=(obj)=>{         //set trip
    this.arrive=obj
   }
   @action setstartride=(obj)=>{         //set trip
    this.startride=obj
   }
   @action setendride=(obj)=>{         //set trip
    this.endride=obj
   }
