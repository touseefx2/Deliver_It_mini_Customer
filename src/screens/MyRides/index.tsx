...
const MyRides = observer((props: Props) => {
  ...
  const getTrips = () => {
    ...
    db.api
      .apiCall("get", db.link.getallTripsbyuid + uid, bodyData, header)
      .then((response) => {
        setloader(false);
        setisserverErr(false);
  ...
  const onclickDetails = (trp) => {
    console.log("cancl by  : ", trp.cancelled_by);

    if (trp.cancelled_by == "captain" || trp.cancelled_by == "customer") {
      ...
      return (
        <View style={[styles.Body, { marginTop: i == 0 ? 20 : 0 }]}>
          ...
          >
            ...
            >
              <Text
                style={{ color: "grey", width: "100%", lineHeight: 20 }}
                numberOfLines={1}
              >
                <FontAwesome name="circle-o" color="#0E47A1" size={10} />{" "}
                {e.pickup.name}
              </Text>
            </View>
            ...
            >
              <Text
                ...
                numberOfLines={1}
              >
                <Icon name="circle" color="#0E47A1" size={10} />{" "}
                {e.dropoff.name}
              </Text>
            </View>
          </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={styles.Container}>
      ...
      {!generalmanager.internet &&
        ...
        !isserverErr &&
        !loader &&
        trip && <utils.TopMessage msg="No internet connection ! " />}
      {!generalmanager.internet &&
        tabIndex == 1 &&
        !isserverErr &&
        !trip &&
      ...
      <View style={styles.Tabs}>
        <TouchableOpacity
          ...
          style={tabIndex == 0 ? styles.TabActive : styles.Tab}
        >
          <Text style={tabIndex == 0 ? styles.TabTextActive : styles.TabText}>
            SCHEDULED
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => setTabIndex(1)}
          style={tabIndex == 1 ? styles.TabActive : styles.Tab}
        >
          <Text style={tabIndex == 1 ? styles.TabTextActive : styles.TabText}>
            HISTORY
          </Text>
        </TouchableOpacity>
      </View>
